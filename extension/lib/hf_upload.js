/* ── HuggingFace Upload Module v0.6.2b ── */
...
var WSP_HFUpload = {
  ...
  generateReadme(config, citations, stats) {
    ...
    var md = "---\n"
      ...
      + "---\n\n"
      + "# " + repoName + "\n\n"
      + "> Collected with [WebScraper Pro](https://github.com/minerofthesoal/Scraper) v0.6.2b\n\n"
      + "## Dataset Description\n\n"
      ...
      + "### Collection Tool\n\n"
      + "- **Tool:** [WebScraper Pro](https://github.com/minerofthesoal/Scraper) v0.6.2b\n"
      ...
      + "---\n\n"
      + "*Generated by [WebScraper Pro](https://github.com/minerofthesoal/Scraper) v0.6.2b*\n";
